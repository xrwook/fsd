import logoDark from "@/shared/assets/react-router/logo-dark.svg";
import logoLight from "@/shared/assets/react-router/logo-light.svg";
  ...
  return (
    <main className="flex items-center justify-center pt-16 pb-4">
      <div className="flex min-h-0 flex-1 flex-col items-center gap-16">
        ...
        <div className="w-full max-w-[320px] space-y-6 px-4">
